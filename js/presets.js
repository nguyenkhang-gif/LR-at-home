...
export const BUILTIN_PRESETS = [
  ...
  // ── Anime ──
  {
    ...
    chain: [
      ...
      { filterId: 'temperature',  params: { value: 14 } },
      { filterId: 'tint',         params: { value: 10 } },
      { filterId: 'saturation',   params: { factor: 1.34 } },
      { filterId: 'clarity',      params: { amount: -20 } },
      { filterId: 'dehaze',       params: { amount: -15 } },
      { filterId: 'grain',        params: { amount: 0.54 } },
      { filterId: 'hsl_adjust',   params: { r_h: 10, r_s: -15, r_l: 0, o_h: 0, o_s: 0, o_l: 0, y_h: 0, y_s: 0, y_l: 0, g_h: 0, g_s: 0, g_l: 0, a_h: 0, a_s: 0, a_l: 0, b_h: 0, b_s: 0, b_l: 0, p_h: 0, p_s: 0, p_l: 0, m_h: 0, m_s: 0, m_l: 0 } },
    ],
  },
  {
    id: 'spirited_away',
